      ...
      <div class="content">
        ...
        <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('experiences.restore',$experience->id)}}" style="color: #e13300;">
                                        <i class="material-icons" data-toggle="tooltip" title="Restore">&#xE923;</i>
                                    </a>
                                    <form action="{{route('experiences.forcedelete',$experience->id)}}" method="get" style="display: inline;">
                                        @csrf
                    ...
                    @endforeach
                    <a href="{{ route('experiences.index') }}" style="color: #e13300; text-decoration: underline;">Experiences Table</a><br><br>
                </thead>
                        <tbody>
