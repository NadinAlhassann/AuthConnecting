 ...
 <div class="content">
        ...
        <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                       <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('contacts.restore',$contact->id)}}" style="color: #e13300;">
                                        <i class="material-icons" data-toggle="tooltip" title="Restore">&#xE923;</i>
                                    </a>
                                    <form action="{{route('contacts.forcedelete',$contact->id)}}" method="get" style="display: inline;">
                                        @csrf
                    ...
                    @endforeach
                    <a href="{{ route('contacts.index') }}" style="color: #e13300; text-decoration: underline;">Contact Us Table</a><br><br>
                </thead>
