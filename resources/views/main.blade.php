...
@section('content')
<div class="blogs-container container-xxl justify-content-center">
        <div class="row gap-3">
            <div class="col-8 d-flex blog-1 p-3" style="width:100%">
                <div class="blogs-img">
                    <img src="{{ asset('Images/pets.jpg') }}" class="" alt="...">
                </div>
                <div class="ms-2">
                    <p class="category-1">Pets</p>
                    <h6 class="blog-title">What Every Pet Owner Should Know</h6>
        ...
        <div class="row gap-3">
            ...
            <div class="col-md-8 blog-7 p-3 d-flex" style="width: 54rem">
                <div>
